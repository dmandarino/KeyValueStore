...
//    
//    var service: KVStackWorker?
//    
//    override func setUp() {
//        service = KVStackWorker()
//        KVStack.items = []
//    }
//    
...
//        //Given
//        KVStack.items = [[KVTransaction(action: .DELETE, key: "foo")]]
//        
//        //When
...
//        //Given
//        KVStack.items = [[KVTransaction(action: .DELETE, key: "foo"), KVTransaction(action: .SET, key: "bar")]]
//        
//        //When
//        guard let (action, key) = service?.pop() else {
//            XCTFail()
...
//        //Given
//        KVStack.items = [[KVTransaction(action: .DELETE, key: "foo"), KVTransaction(action: .SET, key: "bar")], [KVTransaction(action: .DELETE, key: "xpto")]]
//        
//        //When
//        guard let (action, key) = service?.pop() else {
//            XCTFail()
